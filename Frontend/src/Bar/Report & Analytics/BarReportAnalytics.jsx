...
const REPORTS = [
  ...
  {
    // BarServices has exposed /reports/station_performance and
    // /reports/table_turnover all along; this page listed neither, so two
    // working reports had no way to be read.
    label: "Stations",
    endpoint: "/bar/reports/station_performance",
    emptyMessage: "No station activity on this date.",
    columns: [
      { key: "station_name", title: "Station", align: "left" },
      { key: "total_bots", title: "Total BOTs", ...count("total_bots") },
      { key: "completed_bots", title: "Completed", ...count("completed_bots") },
      {
  ...
  {
    label: "Tables",
    endpoint: "/bar/reports/table_turnover",
  ...
  const {
    ...
    [
      ...
      },
      {
        ...
        fetch: () =>
          report.withSummary
            ? APICall.getT("/bar/reports/daily_sales", { report_date: reportDate })
