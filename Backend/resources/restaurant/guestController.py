    ...
    if "sessid" in request.session:
        ...
        try:
            ...
            if created_by is None:
                ...
                return templates.TemplateResponse('restaurant/guest/guest.html', context={'request': request,'color_theme':color_theme,'inquiry_data':inquiry_data,'permision_control':permision_control,
