...
if _configs.SERVICE_NAME != "RestaurantServices":
    raise RuntimeError(
        f"RestaurantServices loaded {_configs.SERVICE_NAME}'s configs package. Start "
...
app = FastAPI(
    title="HotelERP - Restaurant Service",
    version="1.0.0",
    docs_url=_DOCS,
    redoc_url=_REDOC,
...
app.add_middleware(
    ...
    session_cookie="hotelerp_restaurant_session",
    same_site="lax",
