"""Route -> page permission map for the gateway (GENERATED, then reviewed).
...
ROUTE_PERMISSIONS: dict[tuple[str, str, str], tuple[str, ...]] = {
    ...
    ("bar", "reports/daily_sales", "GET"): ("/bar_reports_analytics",),
    ...
    ("hotel", "room_availability", "GET"): ("/add_new_reservation",),
    ...
    ("hotel", "room_reservation", "GET"): ("/reservation", "/reservation_view", "/room_booked_details", "/settlement_summary", "/user_reserved_details",),
    ...
    ("masterdata", "complementry", "GET"): ("/complementary", "/room_type",),
    ...
    ("masterdata", "country_currency", "GET"): ("/currency_country", "/discount_type", "/tax_types",),
    ...
    ("masterdata", "identity_proof", "GET"): ("/ReservationView", "/add_new_reservation", "/identification_proof", "/reservation",),
    ...
    ("masterdata", "room", "GET"): ("/ReservationEdit", "/ReservationView", "/add_new_reservation", "/reservation", "/room_incident_log", "/room_view", "/rooms", "/task_assign",),
    ("masterdata", "room", "POST"): ("/rooms",),
    ("masterdata", "room", "PUT"): ("/rooms",),
    ("masterdata", "room/{id}", "DELETE"): ("/rooms",),
    ("masterdata", "room_types", "GET"): ("/ReservationEdit", "/ReservationView", "/add_new_reservation", "/booking", "/reservation", "/room_type", "/room_view", "/rooms",),
    ("masterdata", "room_types", "POST"): ("/room_type",),
    ("masterdata", "room_types", "PUT"): ("/room_type",),
    ("masterdata", "room_types/{id}", "DELETE"): ("/room_type",),
    ("masterdata", "task_type", "GET"): ("/hsk_task_type",),
    ...
    ("restaurant", "floor", "GET"): ("/floor_layout", "/table_master",),
    ...
    ("restaurant", "kitchen", "GET"): ("/menus", "/recipe_management",),
    ...
    ("restaurant", "reports/daily_sales", "GET"): ("/reports_analytics",),
    ...
    ("user", "users", "GET"): ("/bar_roster", "/bar_shift_planning", "/employee", "/restaurant_roster", "/restaurant_shift_planning", "/task_assign",),
