...
if _configs.SERVICE_NAME != "UserServices":
    raise RuntimeError(
        f"UserServices loaded {_configs.SERVICE_NAME}'s configs package. Start "
...
app.add_middleware(
    ...
    session_cookie="hotelerp_user_session",
    same_site="lax",
