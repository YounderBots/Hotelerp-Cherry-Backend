...
INSERT INTO `roles` VALUES (1,'Admin','Full system access','ACTIVE','1','2026-01-22 12:22:54',NULL,'1'),(2,'Front Office','Handles reservations and check-in','ACTIVE','1','2026-01-22 12:23:02',NULL,'1'),(3,'House Keeping','Room cleaning and maintenance tasks','ACTIVE','1','2026-01-22 12:23:10',NULL,'1');
/*!40000 ALTER TABLE `roles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `submenu_menus`
--

DROP TABLE IF EXISTS `submenu_menus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `submenu_menus` (
  `id` int NOT NULL AUTO_INCREMENT,
  `submenu_id` varchar(100) NOT NULL,
  `menu_id` varchar(100) NOT NULL,
  `submenu_sub_name` varchar(100) NOT NULL,
  `submenu_sub_link` varchar(255) NOT NULL,
  `order` int NOT NULL,
  `status` varchar(100) NOT NULL,
  `created_by` varchar(100) NOT NULL,
  `created_at` datetime DEFAULT (now()),
  ...
  `company_id` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_submenu_menus_submenu_sub_name` (`submenu_sub_name`),
  KEY `ix_submenu_menus_submenu_id` (`submenu_id`),
  KEY `ix_submenu_menus_created_by` (`created_by`),
  KEY `ix_submenu_menus_id` (`id`),
  KEY `ix_submenu_menus_menu_id` (`menu_id`),
  KEY `ix_submenu_menus_company_id` (`company_id`),
  KEY `ix_submenu_menus_status` (`status`),
  KEY `ix_submenu_menus_updated_by` (`updated_by`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `submenu_menus`
--

LOCK TABLES `submenu_menus` WRITE;
/*!40000 ALTER TABLE `submenu_menus` DISABLE KEYS */;
/*!40000 ALTER TABLE `submenu_menus` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-01-28 15:54:28
